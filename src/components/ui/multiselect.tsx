...
const MultipleSelector = ({
    ...
    return (
        ...
        >
            <div
                className={cn(
                    'focus-within:border-ring focus-within:ring-ring/50 has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 has-aria-invalid:border-destructive relative min-h-[36px] rounded-lg border text-sm transition-[color,box-shadow] outline-none focus-within:ring-[3px] has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50',
                    {
            ...
            >
                <div className="flex flex-wrap gap-1">
                    {selected.map(option => {
                        return (
                            <div
                                key={option.value}
                                className={cn(
                                    'animate-fadeIn bg-background dark:bg-input/30 text-secondary-foreground hover:bg-background relative inline-flex h-6.5 cursor-default items-center rounded-lg border ps-2 pe-7 pl-2 text-xs font-medium transition-all disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 data-fixed:pe-2',
                                    badgeClassName
                                )}
                    ...
                    <button
                        ...
                        className={cn(
                            'text-muted-foreground/80 hover:text-foreground focus-visible:border-ring focus-visible:ring-ring/50 absolute end-0 top-0 flex size-9 items-center justify-center rounded-lg border border-transparent transition-[color,box-shadow] outline-none focus-visible:ring-[3px]',
                            (hideClearAllButton ||
                                disabled ||
                                selected.length < 1 ||
