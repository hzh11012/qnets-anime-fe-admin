...
import { tagCreateSchema } from '@/pages/anime/tag/form-schema';
import { tagCreate } from '@/apis';
import { Form } from '@/components/ui/form';
import { Button } from '@/components/ui/button';
import FormInput from '@/components/custom/form/form-input';

type TagFormValues = ZodFormValues<typeof tagCreateSchema>;
...
const AddDialog: React.FC<AddDialogProps> = ({ onRefresh }) => {
    ...
    const { run } = useRequest(tagCreate, {
        manual: true,
        debounceWait: 300,
        onSuccess({ code, msg }) {
            if (code === 200) {
